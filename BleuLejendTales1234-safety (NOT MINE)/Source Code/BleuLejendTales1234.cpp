...
{
	if (MessageBoxW(NULL, L"This is a harmless malware made by anotheraccount\nWarning: this will move your mouse!\n\nClick yes to Run\nClick no to Exit", L"BleuLejendTales1234.exe", MB_YESNO | MB_ICONEXCLAMATION) == IDNO)
	{
		ExitProcess(0);
	}
	else
	{
		if (MessageBoxW(NULL, L"Are you sure? It still contains flashing lights - NOT for epilepsy and it will move your mouse!", L"FINAL WARNING", MB_YESNO | MB_ICONEXCLAMATION) == IDNO)
		{
			ExitProcess(0);
		}
		else
